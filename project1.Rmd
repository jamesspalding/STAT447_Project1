...
fulldata = fulldata %>%
  mutate(agegroup = ifelse(Age <= 65,0,1)) #Create category for age group
...
result = glm(status~.
             ...
             -Shimmer.APQ5
             -MDVP.Fo.Hz.
             -MDVP.Fhi.Hz., data = numericdata, family = "binomial")
#summary(result)
```
