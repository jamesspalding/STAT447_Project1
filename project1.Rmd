...
```{r, fig.show="hold", fig.cap="Logistic regression graphs.", include =F}
##### I could not include these plots because for whatever reason they kept outputting in the wrong spot (a few paragraphs down). They didn't provide much insight anyway, so leaving them out is fine.
...
#The plots in *Figure 3* show that the model is fairly accurate, as the blue dots tend to cluster more towards the top of the graph.
```
